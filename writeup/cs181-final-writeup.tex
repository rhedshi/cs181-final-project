...
As we can see from Figure~\ref{fig:score}, the results are mixed with the most accurate predictions for Latent Class 2 and the least accurate predictions for Latent Class 0. The coefficients of determination shown in the figure are given by

$$ 1 - \frac{\text{sum of squares of residuals}}{\text{sum of square of totals}} $$ 
